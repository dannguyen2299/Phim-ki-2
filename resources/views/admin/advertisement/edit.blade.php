                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="have_paid" class="form-control" id="inputPassword11">
                            <option value="0" <?php if ($advertisement->have_paid == 0) echo 'selected'; ?>>Not Paid</option> <!-- Chưa thanh toán -->
                            <option value="1" <?php if ($advertisement->have_paid == 1) echo 'selected'; ?>>Paid</option> <!-- Đã thanh toán -->
                        </select>
                    </div>
                </div>
                <div class="form-group row">
