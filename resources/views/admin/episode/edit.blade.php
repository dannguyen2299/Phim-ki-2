        ...
        <div class="card mb-5">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <div>
                            <form data-parsley-validate novalidate autocomplete="off" action="{{URL::to('admin_1/update-episode/'.$value->episode_id)}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input required type="text" value="{{$value->url_second}}" name="url_second" class="form-control" id="episode_url_2" placeholder="Category Name" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group row">
