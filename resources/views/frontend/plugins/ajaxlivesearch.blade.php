                ...
                if (bypass_check_last_value || search_object.latest_value !== search_object.value) {
                    ...
                    search_object.to_be_executed = setTimeout(function () {
                        ...
                        if ($.trim(search_object.value).length) {
                            ...
                            //TODO: Hiển thị biến toPostData ra để lấy key value và thêm vào data trong ajax
                            /// Vì biến toPostData là mảng object nên $request không lấy được dữ liệu
                            /// ban đầu là: data: toPostData
                            /// nhớ thêm: _token: "{{ csrf_token() }}
                            ...
                            $.ajax({
                                ...
                                url: ls.url,
                                data: {
                                    ls_anti_bot: toPostData[0].value,
                                    ls_page_loaded_at: toPostData[2].value,
                                    ls_current_page: toPostData[3].value,
                                    ls_query_id: toPostData[4].value,
                                    ls_query: toPostData[5].value,
                                    ls_items_per_page: toPostData[6].value,
                                    _token: "{{ csrf_token() }}"
                                },
                                dataType: "json",
                                cache: ls.cache,
