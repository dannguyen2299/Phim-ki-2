...
class user extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('user')->insert([
            ['user_id'=>1,'email'=>'tranduy@gmail.com','password'=>$password,'name'=>'Trần Thanh Duy','provider'=>'Super Admin','role_id'=>1,'status'=>1],
            ...
            ['user_id'=>6,'email'=>'thanhyeuquynh@gmail.com','password'=>$password,'name'=>'T S2 Q','provider'=>'Super Admin','role_id'=>1,'status'=>1],
            ['user_id'=>7,'email'=>'quynhthichthanh@gmail.com','password'=>$password,'name'=>'Q S2 T','provider'=>'Super Admin','role_id'=>1,'status'=>0]
