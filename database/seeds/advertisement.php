...
class advertisement extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('advertisement')->insert([
            ...
            ['ad_id'=>2,'ad_name'=>"Tên Quảng Cáo 2",'partner'=>'partner','partner_email'=>'partner@gmail.com','partner_phone'=>'094511641561','url_banner'=>'https://previews.123rf.com/images/dzein/dzein1905/dzein190500037/124728750-time-to-travel-ads-banner-up-to-50-off-in-white-space-for-text-with-vector-3d-realistic-traveling-it.jpg','start_date'=>Carbon::create('2020-01-14'),'end_date'=>Carbon::create('2021-03-21'),'price'=>'500000','have_paid'=>'1','ad_location'=>2,'status'=>1],
